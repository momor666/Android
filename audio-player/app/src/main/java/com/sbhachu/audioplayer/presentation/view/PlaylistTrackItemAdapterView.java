...
@EViewGroup(R.layout.view_playlist_track_item)
public class PlaylistTrackItemAdapterView extends LinearLayout {
    ...
    @ViewById(R.id.playlist_delete_item_iv)
    public ImageView deleteImageView;

    public PlaylistTrackItemAdapterView(Context context) {
        super(context);
    }
